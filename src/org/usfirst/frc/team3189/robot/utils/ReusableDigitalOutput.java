...
public class ReusableDigitalOutput extends DigitalSource implements LiveWindowSendable {
	private static final long invalidPwmGenerator = 0xffffffff;
	   ...
	   */
	  public ReusableDigitalOutput(int channel) {
	   ...
	   */
	  public void pulse(final float pulseLength) {
