...
/**
 * 
 * @author Nate A helper class to control pistons
 */
public class Piston {
	 ...
	 * @param retractID channel ID for the retract solenoid
	 * @param extendID channel ID for the extending solenoid
	 * @param isRetracted boolean value for whether the piston is extended or retracted
	 */
	...
	/**
	 * sets defult values
	 * @param retractedID channel ID for the retract solenoid
	 * @param extendID channel ID for the extending soleniod
	 */
