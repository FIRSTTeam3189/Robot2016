...
public class RobotMap {
	...
	public final static int leftShooterTalon = 7;
	public final static int rightShooterTalon =6;
	public final static int leftWindowMotor = 4;
	public final static int rightWindowMotor =5;
	// OI
